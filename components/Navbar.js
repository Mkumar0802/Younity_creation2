    ...
    <div class="">
      <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
        ...
        <ul class="nav nav-pills">
          <li class="nav-item">
            <Link class="nav-link" href="#scrollspyHeading1">
              First
            </Link>
          </li>
          <li class="nav-item">
            <Link class="nav-link" href="#scrollspyHeading2">
              Second
            </Link>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <Link class="dropdown-item" href="#scrollspyHeading3">
                  Third
                </Link>
              </li>
              <li>
                <Link class="dropdown-item" href="#scrollspyHeading4">
                  Fourth
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link class="dropdown-item" href="#scrollspyHeading5">
                  Fifth
                </Link>
              </li>
            </ul>
