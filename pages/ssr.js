...
export async function getServerSideProps(context) {
    const resp = await fetch(`https://6242b6dfb6734894c154f2f6.mockapi.io/a1/employee/`)
    const data = await resp.json()
    console.log(data, 'API Callings')
    return {
...
function ssr({ Ssrdata }) {
    return (
        <div className="container mx-auto">
            {Ssrdata.length === 0 && <p className="text-white bg-red-800">Loading...</p>}
