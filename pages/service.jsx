...
function service() {
  return (
    <div className="">
      <div className="">
        <section class="py-10 bg-[#a27777] w-screen h-screen  sm:py-16 ">
          <div
            class="
		md:bg-[url('https://res.cloudinary.com/drywqd3hf/image/upload/v1670406562/vector4_hiwn0g.svg')]  h-full w-full bg-cover bg-no-repeat  rounded-xl "
          >
            <div className="relative z-40 px-8 py-20 xl:px-20 2xl:mx-auto 2xl:container">
              ...
              <div class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full lg:gap-14">
                <div class="flex flex-col overflow-hidden bg-[#ece0e0] shadow-md rounded-xl">
                  <div class="flex flex-col justify-between flex-1 px-5 py-6">
                    <div class="flex-shrink-0">
                      <span class="block text-xs font-semibold tracking-widest text-orange-500 uppercase">
                        {" "}
                        Lifestyle{" "}
                      </span>
                    </div>
                    ...
                    <div class="flex">
                      <div class="flex items-center flex-1 px-6 py-5">
                        <img
                          ...
                          alt=""
                        />
                        <span class="flex-1 block min-w-0 ml-3 text-base font-semibold text-gray-900 truncate">
                          {" "}
                          Wade Warren{" "}
                        </span>
                      </div>
                      ...
                      <a
                        href="#"
                        title=""
                        class="inline-flex items-center flex-shrink-0 px-4 py-5 text-base font-semibold transition-all duration-200 bg-[#ece0e0]  border-l border-gray-200 hover:bg-blue-600 hover:text-white"
                      >
                        Read more
                        <svg
                          class="w-5 h-5 ml-2"
